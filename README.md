...
- 🎨 **外观风格**：经典毛绒 / 毛绒实拍精灵表 / 矢量扁平，右键或托盘可切换（会记住选择）
- 🔔 **系统托盘**：显示/隐藏宠物、聊聊天、退出；双击托盘恢复显示
- 📏 **滚轮缩放**：鼠标滚轮可以调整角色大小
- 📋 **右键菜单**：
  - 聊聊天 / 隐藏
  - 调整大小（小/中/大/超大）
...
├── chat.py                          # 本地关键词回复
├── tray.py                          # 系统托盘
├── eggplant.png                     # 经典毛绒角色图
├── eggplant.ico                     # Windows 应用 / EXE 图标
├── eggplant-spritesheet-*-rgba.png  # 毛绒实拍 / 矢量扁平精灵表
├── appearance.py                    # 外观风格切换
